...
import { getFirestore, collection, doc, addDoc, getDoc, getDocs, setDoc, updateDoc, query, where, orderBy, limit, startAt, startAfter, Timestamp} from "https://www.gstatic.com/firebasejs/10.1.0/firebase-firestore.js";
...
export { db, auth, collection, doc, addDoc, getDoc, getDocs, setDoc, updateDoc, query, where, orderBy, limit, startAt, startAfter,    //first level
