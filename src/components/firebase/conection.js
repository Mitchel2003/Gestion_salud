...
import { getFirestore, collection, doc, addDoc, getDocs, setDoc, query, where, orderBy, limit } from "https://www.gstatic.com/firebasejs/10.1.0/firebase-firestore.js";
...
export { db, auth, collection, doc, addDoc, getDocs, setDoc, query, where, orderBy, limit,    //first level
